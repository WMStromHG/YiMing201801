...
// Loads.copy("bg", "bg_copy");
// Loads.copy("play", "play_copy");
// Loads.copy_run(function(){
//
//     $(".cc .bg.p").css("background-image", "url("+Loads.copy_img["bg_copy"]+")");
//     $(".Play").css("background-image", "url("+Loads.copy_img["play_copy"]+")");
//     Room.Loading.btn()
// });
